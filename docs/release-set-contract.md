...
Configure the builder's `Candidate Build` environment separately with:

- secret `SOURCE_REPOSITORY`;
- secret `SOURCE_READ_DEPLOY_KEY`;
- variable `CANDIDATE_MATERIALIZATION_RECIPIENT`;
- variable `CANDIDATE_MATERIALIZATION_KEY_ID`.
