...
Typical user signals: "discuss this with another coding agent", "brainstorm with another agent", "spawn an implement/check worker", "let an agent review", "open an issue board or changelog forum", "look at this thread", "the channel is stuck or has no output", "progress was truncated", and "how do I write that channel command?"
...
| User intent | Read |
|---|---|
| "Discuss this with another coding agent", "brainstorm with another agent" | `references/workflows.md` |
| "Dispatch an implement/check agent", "let an agent review", "spawn a worker" | `references/workflows.md`, then `references/workers.md` |
| "Open an issue area, topic forum, changelog, or board", "make a forum" | `references/forum.md` |
| "Inspect this thread or linked context", "inspect a thread" | `references/forum.md` |
| "The channel is stuck, has no output, or progress was truncated", "worker stalled" | `references/progress-debugging.md` |
| "How should this command be written?", "what flags does X take" | `references/command-reference.md` |
