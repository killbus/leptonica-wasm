...
Patterns are grouped by the *intent* behind the phrasing, not the surface words. The same intent appears in different registers.
...
- "How did we fix the similar case before?"
- "I remember solving something like this earlier."
- "Can you recover the reasoning from the previous fix?"
...
- "What did we previously decide about X?"
- "Did we discuss an approach for X before?"
...
- "Is this the same bug as last time?"
- "Why are we seeing this error again?"
...
- "Do I keep falling into this trap?"
- "Do I keep making this mistake?"
- "How many times has this kind of issue appeared?"
...
- "Summarize the lessons from this task."
- "Record the pitfalls from this work."
- "Review this task retrospectively."
